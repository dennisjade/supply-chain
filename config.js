( function(){
  ...
  config.yesnoWEIBULLMsg = props.yesnoWEIBULLMsg || "Hi #{username}, \n\n Here is the #{classType} prediction for IBMPN #{partNumber}.\n Vintage #{vintageNumber}. \n\n The 5-year project for this IBMPN and vintage is #{prediction}. \n\n Do you want to notify technical support team?"
  config.yesnoOVERALLMsg = props.yesnoOVERALLMsg || "Hi #{username}, \n\n Here is the #{classType} for IBMPN #{partNumber}.\n Vintage #{vintageNumber}. \n\n #{summaryRemarks} \n#{arrDesc} \n #{ppmDesc} \n#{tcoBucketDescAndFlag} \n#{fiveYrBucketDesc} \n\n Do you want to notify technical support team?"
